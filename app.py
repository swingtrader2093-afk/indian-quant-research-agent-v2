...
def build_report(results,cfg,detail):
    ...
    L=["# Indian Quant Research Agent V2.6.3 — NSE Stock Screening, Quant Research & Parallel Pattern Scan Report",
...
if os.environ.get("QUANT_WORKER") != "1":
    ...
    st.title("🤖 Indian Quant Research Agent V2.6.3 — NSE Stock Screening, Quant Research & Parallel Pattern Scan")
    ...
    if job_id:
        ...
        if status.get("status")=="complete":
            ...
            if payload:
                ...
                st.download_button("⬇️ Download COMPLETE EVIDENCE BUNDLE",bundle,file_name="indian_quant_research_agent_v2_6_3_evidence.zip",mime="application/zip")
